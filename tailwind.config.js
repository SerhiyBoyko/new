module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'x': ['10px',{ lineHeight: '1.5' }],
        'h1-m': ['30px',{ lineHeight: '1.24' }],
        'h1-t': ['48px',{ lineHeight: '1.24' }],
        'h1-d': ['64px',{ lineHeight: '1.24' }],
        'mbace': ['16px',{ lineHeight: '1.5' }],
        'mtitle': ['18px',{ lineHeight: '1.5' }],
      },
      spacing: {
        '2px': '2px',
        '5px': '5px',
